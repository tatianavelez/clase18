...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseList.add(CourseRVModal("C++ Development", R.drawable.css))
        ...
        courseList.add(CourseRVModal("JavaScript Development", R.drawable.javascript))
